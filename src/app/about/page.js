...
const ABOUT_FAQ = [
  {
    question: "Why was TrendSEO founded?",
    answer: "TrendSEO was built to bridge the gap between static, slow-moving traditional optimization and the fast-paced nature of modern digital algorithms. We recognized that businesses didn't just need static keywords—they needed an agile partner capable of capitalizing on real-time market trends.",
  },
  {
  ...
  {
    question: "What makes TrendSEO different from a traditional marketing agency?",
  ...
  {
    question: "Where is the TrendSEO team located?",
