...
import EngineFeaturesSection from '@/components/LocalSEO/EngineFeaturesSection'
import ExpectedResultsSection from '@/components/LocalSEO/ExpectedResultsSection'
import IndustryVerticals from '@/components/LocalSEO/IndustryVerticals'
import LocalSEODefinition from '@/components/LocalSEO/LocalSEODefinition'
import LocalSEOProcess from '@/components/LocalSEO/LocalSEOProcess'
import MapsDominationSection from '@/components/LocalSEO/MapsDominationSection'
import TechDeploySection from '@/components/LocalSEO/TechDeploySection'
import WhyBusinessNeedsThis from '@/components/LocalSEO/WhyBusinessNeedsThis'
...
const page = () => {
  return (
    <>
     <MapsDominationSection />
     <LocalSEODefinition />
     <WhyBusinessNeedsThis />
     <LocalSEOProcess />
