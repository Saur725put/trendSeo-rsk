...
import TechnicalEngineFeaturesSection from "@/components/TechnicalSEO/TechnicalEngineFeaturesSection";
import TechnicalExpectedResultsSection from "@/components/TechnicalSEO/TechnicalExpectedResultsSection";
import TechnicalIndustryVerticals from "@/components/TechnicalSEO/TechnicalIndustryVerticals";
import TechnicalMapsDominationSection from "@/components/TechnicalSEO/TechnicalMapsDominationSection";
import TechnicalSEODefinition from "@/components/TechnicalSEO/TechnicalSEODefinition";
import TechnicalSEOProcess from "@/components/TechnicalSEO/TechnicalSEOProcess";
import TechnicalTechDeploySection from "@/components/TechnicalSEO/TechnicalTechDeploySection";
import TechnicalWhyBusinessNeedsThis from "@/components/TechnicalSEO/TechnicalWhyBusinessNeedsThis";
...
const page = () => {
  return (
    <>
      <TechnicalMapsDominationSection />
      <TechnicalSEODefinition />
      <TechnicalWhyBusinessNeedsThis />
      <TechnicalSEOProcess />
      <TechnicalEngineFeaturesSection />
      <TechnicalTechDeploySection />
      <TechnicalIndustryVerticals />
      <TechnicalExpectedResultsSection />
