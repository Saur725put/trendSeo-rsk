...
import Typewriter from "./Typewriter"; // Typewriter को इम्पोर्ट किया
    ...
    >
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          ...
          {/* Headline with Typewriter attached only to 'One growth machine.' */}
          <h2 className="text-5xl md:text-7xl font-bold tracking-tight leading-[1.05] text-zinc-900 mb-6">
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-5">
                  <span
                    style={{ color: isHovered ? "rgba(255,255,255,0.5)" : "#a1a1aa" }}
                  ...
                  <motion.span
                    ...
                    style={{ color: isHovered ? "rgba(255,255,255,0.7)" : "#a1a1aa" }}
                ...
                <div
                  style={{
                    backgroundColor: isHovered ? "rgba(0,0,0,0.25)" : "#18181b",
                  }}
                  ...
                  {service.tags.map((tag) => (
                    <span
                      ...
                      style={{
                        ...
                        borderColor: isHovered ? "rgba(255,255,255,0.3)" : "#d4d4d8",
