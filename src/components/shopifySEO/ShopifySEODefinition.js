...
export default function ShopifySEODefinition() {
  return (
    <section
      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col items-start">
        ...
        <div className="relative pl-0 md:pl-8 flex flex-col items-start space-y-6">
          ...
          <p className="text-zinc-400 text-base md:text-xl font-normal leading-relaxed max-w-3xl">
            Shopify ships fast but ranks slow without intervention. We rebuild your theme architecture, 
            eliminate Liquid-induced duplicates, optimize Shopify-specific URL structures, and tune 
            apps that quietly drag your CWV down.
          </p>
        </div>
      </div>
    </section>
