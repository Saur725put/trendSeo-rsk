...
export default function WhyBusinessNeedsThis() {
  const points = [
    {
      num: "01",
      title: "Hyper-Local Intent",
      desc: "97% of nearby searches result in a visit within 24 hours.",
      // Custom classes for Card 1 hover state
    ...
    {
      num: "02",
      title: "Trust by Proximity",
      desc: "Map Pack listings outperform organic in CTR for local queries.",
      // Custom classes for Card 2 hover state
    ...
    },
    {
      ...
      desc: "We engineer review pipelines that boost both ranking and conversion.",
      // Custom classes for Card 3 hover state
    ...
    },
    {
      ...
      desc: "From single-shop to 1,000-location franchise systems.",
      // Custom classes for Card 4 hover state
