...
export default function TechnicalWhyBusinessNeedsThis() {
  const points = [
    {
      num: "01",
      title: "Unlock Existing Content",
      desc: "Most sites have rankings buried under crawl waste — we surface them.",
    ...
    },
    {
      ...
      desc: "Every 100ms shaved off LCP lifts revenue 1-3%.",
    ...
    },
    {
      ...
      desc: "Replatforms, redesigns, and SPAs without ranking loss.",
    ...
    },
    {
      num: "04",
      title: "Future-Proof",
      desc: "AI Overviews, Discover, and SGE-ready architecture.",
