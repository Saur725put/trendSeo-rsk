...
export default function TechnicalSEODefinition() {
  return (
    <section
      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col items-start">
        ...
        <div className="relative pl-0 md:pl-8 flex flex-col items-start space-y-6">
          ...
          <p className="text-zinc-400 text-base md:text-xl font-normal leading-relaxed max-w-3xl">
            Without a clean technical foundation, every content dollar leaks. We audit your render pipeline, log files,
            indexation, JS execution, and schema graph — then ship a prioritized punch-list with engineering hand-offs.
          </p>
        </div>
      </div>
    </section>
